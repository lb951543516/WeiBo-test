...
Revision ID: 563a72309237
Revises: 
Create Date: 2020-08-27 20:46:42.383476
...
def upgrade():
    ...
    op.create_index(op.f('ix_blog_uid'), 'blog', ['uid'], unique=False)
    ...
    op.create_index(op.f('ix_comment_bid'), 'comment', ['bid'], unique=False)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_comment_bid'), table_name='comment')
    op.drop_table('comment')
    op.drop_index(op.f('ix_blog_uid'), table_name='blog')
    op.drop_table('blog')
    # ### end Alembic commands ###
